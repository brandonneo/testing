<?php 
   ...
   redirectIfNotAdmin();
   $data = viewAllUser($_SESSION['email']);
?>
<!DOCTYPE html> 
<html lang="en">
<head>
  ...
  #btn {
    text-align:center;}
    th {
      background-color: #84a394 !important;
      color: white;
    } 
  </style>
  <script>
  ...
  <section class="py-5">
    ...
    <tbody>
      ...
      '<tr>
        ...
        <td id="btn"><a href="merchant_delete_user_post.php?id='.$item["userID"].'"<button type="button"  class="btn btn-danger btn-rounded btn-sm my-0 delete-button">Remove</button></span></a></td>
      </tr>
      ';
    }
      ?>
