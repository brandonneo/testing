...
<body>
  <section class="py-5">
    <form action="merchant_add_product_post.php" method="POST" enctype="multipart/form-data">
      <header>
        <h2>Add Product</h2>
    ...
    <div>
      ...
      <div>
        <select id="Field106" name="brand" class="field select medium" tabindex="11">
          ...
          <option value="Anothersole">Anothersole</option>
          <option value="Charles & Keith">Charles & Keith</option>
          <option value="Lucca Vudor">Lucca Vudor</option>
    ...
    <div>
        <select id="Field106" name="gender" class="field select medium" tabindex="11">
    ...
    <div>
      ...
      <div>
        <input id="Field1" name="price" type="text" class="field text fn" value="" size="8" tabindex="1">
      </div>
    </div>
    ...
    <div>
      ...
      <div>
        <input id="Field1" name="size6" type="text" class="field text fn" value="0" size="8" tabindex="1">
      </div>
    </div>
    <div>
      <label class="desc" id="title1" for="Field1">Size 7</label>
      <div>
        <input id="Field1" name="size7" type="text" class="field text fn" value="0" size="8" tabindex="1">
      </div>
    </div>
    <div>
      <label class="desc" id="title1" for="Field1">Size 8</label>
      <div>
        <input id="Field1" name="size8" type="text" class="field text fn" value="0" size="8" tabindex="1">
      </div>
    </div>
    <div>
      <label class="desc" id="title1" for="Field1">Size 9</label>
      <div>
        <input id="Field1" name="size9" type="text" class="field text fn" value="0" size="8" tabindex="1">
      </div>
    </div>
    <div>
      <label class="desc" id="title1" for="Field1">Size 10</label>
      <div>
        <input id="Field1" name="size10" type="text" class="field text fn" value="0" size="8" tabindex="1">
      </div>
    </div>
    <div>
      <label class="desc" id="title1" for="Field1">Size 11</label>
      <div>
        <input id="Field1" name="size11" type="text" class="field text fn" value="0" size="8" tabindex="1">
      </div>
    </div>
    <div>
      <label class="desc" id="title1" for="Field1">Size 12</label>
      <div>
        <input id="Field1" name="size12" type="text" class="field text fn" value="0" size="8" tabindex="1">
      </div>
    </div>
    <hr>
    <div>
